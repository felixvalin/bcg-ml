...
## Baseparameters 
num_of_clusters = 10000 # Starts with most massive and descending order
basePath = '/data/TNG300-2/output' # Worst resolution TNG300
# basePath = 'sims.illustris/Illustris-3/output'
# snapshot = 99 # z = 0
snapshots = [84,78,72,67,59,50,40,33,25,21,17]
